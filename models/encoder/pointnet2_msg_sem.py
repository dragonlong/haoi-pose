...
from models.encoder.pointnet2_ssg_sem import PointNet2SemSegSSG
from common import bp

class PointNet2SemSegMSG(pl.LightningModule):
    ...
    def forward(self, pointcloud):
        ...
        return self.fc_layer(l_features[0]), None
