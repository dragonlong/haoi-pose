...
exp_args = parser.add_parser("experiment") # no experiment
exp_args.add_argument('--experiment-id', type=str, default='airplane',
                      help='experiment id')
exp_args.add_argument('--model-id', type=str, default='0.01',
                      help='model id for naming')
exp_args.add_argument('-d', '--dataset-path', type=str, default='/groups/arcadm/xiaolong/modelnet40/EvenAlignedModelNet40PC',
                      help='path to datasets')
exp_args.add_argument('--dataset', type=str, default='kpts',
                      help='name of the datasets')
exp_args.add_argument('--model-dir', type=str, default='/groups/CESCA-CV/ICML2021/model/oracle/',
                      help='path to models')
exp_args.add_argument('-s', '--seed', type=int, default=2913,
                      help='random seed')
exp_args.add_argument('--use-wandb', action='store_true',
                      help='use_wandb to record training loss')

# Network arguments
net_args = parser.add_parser("model") # with model
...
net_args.add_argument('-u', '--flag', type=str, default='rotation',
...
# Training arguments
train_args = parser.add_parser("train") # no train
...
lr_args = parser.add_parser("train_lr") # add train_lr
...
loss_args = parser.add_parser("train_loss") # add train_loss
...
# Eval arguments
eval_args = parser.add_parser("eval") # no eval
eval_args.add_argument('--eval-on', action='store_true',
                      help='eval_mode')
# Test arguments
