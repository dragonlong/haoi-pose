...
| Partial airplane  | EPN            | EPN           | 3.31       | 1.46         | ?          | 0.02                                | 0.95          | 0.76        |
...
5. Compared to other equivariant networks like SE(3) transformer, EPN doesn’t need expensive spherical harmonics computation, which is relatively efficient regarding computation;  
6. Here we add quantitative ablation showing how well the model will perform after being trained under bias viewpoints distribution. We specifically generated partial airplane dataset with viwpoints randomly sampled from a 1/4 sphere 

- Ablation study over different training data scale:
  
| Dataset           | Training Data   | Mean R_err | Median R_err | Mean T_err | Median T_err                        | 5degrees Acc. | 5degree0.05 |
| :---------------- | :-------------- | :--------- | :----------- | :--------- | :---------------------------------- | :------------ | :---------- |
| Complete airplane | Original data   | 23.09      | 1.66         | /          | /                                   | 0.87          | /           |
| Complete airplane | 50% instances    | 20.22      | 2.38         | /          | /                                   | 0.86          | /           |
| Complete airplane | 25% instances    | 18.38      | 2.41         | /          | /                                   | 0.88          | /           |
| Partial airplane  | Original data   | 3.47       | 1.58         | 0.02       | 0.02                                | 0.95          | 0.88        |
| Partial airplane  | 50% instances    | 4.53       | 1.34         | 0.02       | 0.02                                | 0.94          | 0.87        |
| Partial airplane  | 25% instances    | 4.84       | 2.02         | 0.02       | 0.02                                | 0.94          | 0.87        |
| Partial airplane  | 25% viewpoints  | 3.00       | 1.49         | 0.02       | 0.02                                | 0.96          | 0.88        |
| Partial airplane  | 50% viewpoints  | 3.14       | 1.37         | 0.02       | 0.02                                | 0.95          | 0.88        |
| Partial airplane  | 200% viewpoints | 2.44       | 1.53         | 0.02       | 0.02                                | 0.96          |0.88             |


- Quantitative ablations for model limitation under bias viewpoints distribution:

| Dataset           | view points   | Mean R_err | Median R_err | Mean T_err | Median T_err | 5degree | 5degree0.05 |
| :---------------- | :------------ | :--------- | :----------- | :--------- | :----------- | :------------ | :---------- |
| Partial airplane | Unbiased       | 3.47       | 1.58         | 0.02       | 0.02                                | 0.95          | 0.88        |
| Partial airplane | Biased         | 5.63       | 2.14        | 0.03       | 0.02                                | 0.91          | 0.83        |
### R3
...
4. The second car in Figure 2 looks , check car input visualization;
...
| Complete airplane | KPConv         | EPN           | 133.89     | 169.96       | /          | /                                   | 0.00          | /           |
| Partial airplane  | EPN            | EPN           | 3.47       | 1.58         | 0.02       | 0.02                                | 0.95          | 0.88        |
...
| :---------------- | :------- | :--------- | :----------- | :--------- | :---------------------------------- | :------------ | :---------- |
| Complete airplane | EPN20    | 64.12      | 2.40         | /          | /                                   | 0.63          |/            |
| Complete airplane | EPN60    | 23.09      | 1.66         | /          | /                                   | 0.87          | /           |
| Partial airplane  | EPN20    |            |              |            |                                     |               |             |
| Partial airplane  | EPN60    | 3.47       | 1.58         | 0.02       | 0.02                                | 0.95          | 0.88        |
...
| Partial car       | 1,2,3  | 138.19,136.51,   | 176.06,176.09  | 0.11,0.05  | 0.11,0.04 | 0.18,0.17      | 0.00,0.13   |
