...
datapoint = dataset.__getitem__(2)
# Model
model = config.get_model(cfg, device=device, dataset=dataset)
checkpoint_io = CheckpointIO(out_dir, model=model)
# pretrained_path = '/home/lxiaol9/3DGenNet2019/occupancy_networks/onet_pcl2mesh-5c0be168.pt'
pretrained_path = '/groups/CESCA-CV/ICML2021/model/occupancy/0.2/model_best.pt'
if pretrained_path is not None:
    checkpoint_io.load(pretrained_path)
else:
...
for it, data in enumerate(tqdm(test_loader)):
    ...
    # try:
    #     load_dict = checkpoint_io.load('/home/lxiaol9/3DGenNet2019/occupancy_networks/onet_pcl2mesh-5c0be168.pt')
