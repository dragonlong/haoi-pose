import os
from common.train_utils import ensure_dirs
import argparse
import json
import shutil
...
class Config(object):
    ...
    def _add_basic_config_(self, parser):
        ...
        group.add_argument('--module', type=str, choices=['ae', 'vae', 'gan'], required=False,
                           help="which network module to set")

    def _add_dataset_config_(self, parser):
        """add hyperparameters for dataset configuration"""
        group = parser.add_argument_group('dataset')
        group.add_argument('--dataset_name', type=str, choices=['partnet', 'partnet_scan', '3depn'], required=False,
