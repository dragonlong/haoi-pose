...
class create:
    ...
    def cube(objName, v=0.5, loc=(0, 0, 0)):
        bpy.ops.mesh.primitive_cube_add(radius=v, location=loc)
        active.rename(objName)
    def sphere(objName, v=0.5, l=(0, 0, 0)):
        bpy.ops.mesh.primitive_uv_sphere_add(size=v, location=loc)
        active.rename(objName)
    def cone(objName, v=0.5, l=(0, 0, 0)):
        bpy.ops.mesh.primitive_cone_add(radius1=v, location=loc)
        active.rename(objName)
...
def main():
    ...
    #
    dirname = '/home/dragon/Dropbox/ICML2021/code/haoi-pose/evaluation/mini_test/'

    # create a Cube
    create.cube('PerfectCube', v=0.5, loc=(0.5, 0.5, 0.5))
    ...
    viewpoints[..., 1] = (np.random.rand(view_num) - 0.5) * 0 + 120 # elevation
