...
augment=True MODEL.num_in_channels=1 \
r_method_type=1 \
eval=True save=True 2>&1 | tee evaluation/logs/0.8561.txt
#
...
echo 0.8562a1: # bottle, add quaternion limitation
...
use_axis=True  \
use_fps_points=True r_method_type=1 \
eval=True save=True 2>&1 | tee evaluation/logs/0.8562a1.txt
