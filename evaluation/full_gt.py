...
import _init_paths
from lib.vis_utils import plot3d_pts, draw, plot2d_img, plot3d_pts, plot_arrows, plot_arrows_list, plot_distribution, viz_err_distri
from lib.eval_utils import hungarian_matching, compute_joint, compare_similarity_3d_line
from lib.data_utils import get_test_seq, get_test_group, get_demo_h5
...
if __name__ == '__main__':
    ...
    if args.domain == 'demo':
        test_group      = get_demo_h5(all_test_h5)
    else:
